...
<div id="wrapper">
	...
	<div id="menu-wrapper">
		<ul id="menu">
			...
			<li><a href="calculate_load.jsp"><span>Add Product</span></a></li>
                        <li><a href="rate.jsp"><span>Delete Product</span></a></li>
                        <li><a href="feedback.jsp"><span>Edit Product</span></a></li>
